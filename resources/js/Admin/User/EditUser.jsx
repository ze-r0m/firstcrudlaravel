...
export default function EditUser({user, languages, services, cities}) {
    ...
    const langOptions = languages.map(lang => ({
        id: lang.id,
        value: lang.id,
        label: t(`common:language.${lang.name}`)
    }))
    ...
    return (
        <Page>
            ...
            <FormTable>
                ...
                <CaptionCell>
                    <OptionItemNameWithError error={errors.languages}>
                        {t('common:languages')} *
                    </OptionItemNameWithError>
                </CaptionCell>
                <ValueCell>
                    ...
                    <OptionItemErrorText errorText={errors.languages}/>
                </ValueCell>
