...
export default function Registration({phone, services, cities}) {
    ...
    // console.log(countries, services, cities)
    ...
    return (
        <>
            ...
            <Subheader>
                {t("registration.YouVerifiedPhone")}: {phone}
            </Subheader>
            <ContentWrapper>
                <form className='space-y-6' onSubmit={submit}>
                    <OptionsList>
                        <OptionItem>
                            <OptionItemName className={errors.password ? 'text-red-500' : '' + 'text-sm'}>{t("Password")}</OptionItemName>
                            <OptionItemInputPasswordField
                        ...
                        <OptionItem>
                            <OptionItemName className={errors.password ? 'text-red-500' : '' + 'text-sm'}>{t("RepeatPassword")}</OptionItemName>
                            <OptionItemInputPasswordField
                                className={`w-full ${errors.password ? 'border-red-500' : ''}`}
                            ...
                            <div className={'flex justify-start items-center gap-2'}>
                                ...
                                <div className={"tooltip white"}>
                                    ...
                                    <div className="tooltiptext text-sm !w-[300px]">
                                        {t('registration.chooseClosestCity')}
                                    </div>
                                </div>
                            </div>
                        </OptionItemTitle>
